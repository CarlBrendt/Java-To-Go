...
public class Utils {
  ...
  public String selectInterval(String source, Interval interval) {
    return source.substring(interval.getStart().start, interval.end.end);
  }

  public String replacePlaceholders(String source, Function<String, String> replacer, Pattern leftPattern, Pattern rightPattern, int rightSize) {
