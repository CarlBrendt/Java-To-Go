...
public class DateHelper {
  ...
  public String asTextISO(Timestamp timestamp, String ifNull) {
    return asTextISO(Instant.ofEpochSecond(timestamp.getSeconds(), timestamp.getNanos()), ifNull);
  }

  public String asTextISO(Timestamp timestamp) {
    return asTextISO(timestamp, null);
  }
  ...
  public String asTextInZone(OffsetDateTime odt, ZoneOffset zoneOffset) {
    Objects.requireNonNull(odt);
    Objects.requireNonNull(zoneOffset);
    OffsetDateTime converted = odt.withOffsetSameInstant(zoneOffset);
    return converted.format(ISO_OFFSET_DATE_TIME_FORMATTER);
  }
