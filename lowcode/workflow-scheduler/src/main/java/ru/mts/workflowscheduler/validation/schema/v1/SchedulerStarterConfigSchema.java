...
public class SchedulerStarterConfigSchema extends ObjectSchema {
  ...
  public SchedulerStarterConfigSchema(Constraint ...constraint) {
    this(List.of(constraint));
  }

  public SchedulerStarterConfigSchema(List<Constraint> constraints) {
    super(constraints);
