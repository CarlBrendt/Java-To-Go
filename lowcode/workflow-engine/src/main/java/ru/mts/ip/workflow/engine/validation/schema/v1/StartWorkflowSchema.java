...
public class StartWorkflowSchema extends ObjectSchema {
  ...
  public StartWorkflowSchema(Constraint ...constraints) {
    super(constraints);
    ...
    putField(WORKFLOW_START_CONFIG, new ObjectSchema(Map.of(
      ...
      EXECUTION_TIMEOUT, new StringSchema(NOT_NULL, NOT_BLANK, VALID_DURATION, DURATION_NOT_NEGATIVE)
    ), FILLED, NOT_NULL));
  }
