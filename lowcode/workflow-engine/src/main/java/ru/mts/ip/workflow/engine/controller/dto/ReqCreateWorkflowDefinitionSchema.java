...
public class ReqCreateWorkflowDefinitionSchema extends ObjectSchema{
  ...
  public ReqCreateWorkflowDefinitionSchema(Constraint ...constraints) {
    super(constraints);
  ...
  public ReqCreateWorkflowDefinitionSchema(Map<String, BaseSchema> nestedFields, Constraint ...constraints ) {
    this(constraints);
    nestedFields.forEach(this::putField);
  }
