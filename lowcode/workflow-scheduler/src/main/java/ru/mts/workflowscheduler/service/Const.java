...
public interface Const {
  ...
  interface StarterJsonSchema {
    //TODO
    String SCHEDULER_JSON = "{\"type\":\"object\",\"required\":[\"headers\",\"key\",\"payload\",\"topic\"],\"properties\":{\"topic\":{\"type\":\"string\"},\"key\":{\"type\":[\"string\",\"object\",\"number\",\"integer\",\"array\",\"boolean\",\"null\"]},\"headers\":{\"type\":\"object\"},\"payload\":{\"type\":[\"object\",\"string\",\"number\",\"integer\",\"array\",\"boolean\",\"null\"]}}}";
  }
  ...
  public interface SchedulerWorkerStatus {
  ...
  public interface SchedulerStarterStatus {
    String STARTED = "started";
    String TERMINATED = "terminated";
    String ERROR = "error";
  ...
  public interface KafkaAuthType {
     String SASL = "SASL";
     List<String> POSSIBLE_VALUES = List.of(SASL);
  }
