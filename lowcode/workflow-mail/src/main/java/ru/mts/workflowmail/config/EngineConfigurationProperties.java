...
public class EngineConfigurationProperties {
  ...
  private WorkflowExecutionDefaultConfig workflowExecutionConfig =
      new WorkflowExecutionDefaultConfig();
  ...
  private int mailWorkerLimitCount;
  private long maxVariableSizeBytes;
  private long pollMessageDelaySeconds;
  private int maxMessageFetchSize;
