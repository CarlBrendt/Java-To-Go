...
import ru.mts.workflowmail.controller.dto.ResCommonErrorWithDescriptions;
import ru.mts.workflowmail.controller.dto.ResRestTemplateErrorDescription;
import ru.mts.workflowmail.exception.ConstraintViolationException;
import ru.mts.workflowmail.exception.EntityNotFoundException;
import ru.mts.workflowmail.exception.WorkflowEngineException;
...
import static ru.mts.workflowmail.controller.dto.ResRestTemplateErrorDescription.*;
...
public class GlobalControllerExceptionHandler {
  ...
  public ResponseEntity<ResCommonErrorWithDescriptions> handleEntityNotFoundException(EntityNotFoundException ex,
    ...
    body.setPath(req.getRequestURI());
    body.setError(status.getReasonPhrase());
    ResErrorDescription resErr = new ResErrorDescription().setSystemMessage(ex.getMessage());
    body.setErrorDescriptions(List.of(resErr));
    return new ResponseEntity<>(body, status);
  }
