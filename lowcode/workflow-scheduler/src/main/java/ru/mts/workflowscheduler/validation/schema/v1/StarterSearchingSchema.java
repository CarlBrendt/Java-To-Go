...
import ru.mts.workflowscheduler.share.validation.schema.ArraySchema;
import ru.mts.workflowscheduler.share.validation.schema.NumberSchema;
...
import static ru.mts.workflowscheduler.share.validation.Constraint.ACCEPTABLE_SORTING_DIRECTION;
import static ru.mts.workflowscheduler.share.validation.Constraint.ACCEPTABLE_STARTER_SORTING_FIELD;
import static ru.mts.workflowscheduler.share.validation.Constraint.ACCEPTABLE_STARTER_STATUSES;
import static ru.mts.workflowscheduler.share.validation.Constraint.FILLED;
import static ru.mts.workflowscheduler.share.validation.Constraint.MAX_100;
import static ru.mts.workflowscheduler.share.validation.Constraint.NOT_BLANK;
import static ru.mts.workflowscheduler.share.validation.Constraint.NOT_NEGATIVE;
import static ru.mts.workflowscheduler.share.validation.Constraint.NOT_NULL;
import static ru.mts.workflowscheduler.share.validation.Constraint.VALID_UUID;
